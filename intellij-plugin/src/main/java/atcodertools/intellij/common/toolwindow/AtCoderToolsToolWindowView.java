...
public class AtCoderToolsToolWindowView {
    ...
    public AtCoderToolsToolWindowView(@NotNull Project project) {
        ...
        DefaultActionGroup actionGroup = new DefaultActionGroup(
                ActionManager.getInstance().getAction("atcodertools.intellij.common.action.StopAction"),
                Separator.getInstance(),
                ActionManager.getInstance().getAction("atcodertools.intellij.common.action.GenAction"),
                ActionManager.getInstance().getAction("atcodertools.intellij.common.action.TestAction"),
                Separator.getInstance(),
                ActionManager.getInstance().getAction("atcodertools.intellij.common.action.SubmitAction"));
