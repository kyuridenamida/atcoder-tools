package atcodertools.intellij.common.command
...
import atcodertools.intellij.common.util.getProblemMetadataForProblem
...
fun executeGenCommand(facet: AtCoderToolsFacet) {
    ...
    val command = GeneralCommandLine("atcoder-tools", "gen").apply {
        ...
        if (System.getProperty("atcodertools.intellij.common.command.noLogin", "false").toBoolean()) {
