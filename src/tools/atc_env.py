...
from code_generation.CppCodeGenerator import CppCodeGenerator
from file_creator.FileCreator import FileCreator
from models.ProblemContent import InputFormatDetectionError, SampleDetectionError
from src.client.AtCoderClient import AtCoderClient, Contest, LoginError
from src.format_prediction.FormatPredictor import FormatPredictor, NoPredictionResultError, \
...
def prepare_procedure(atcoder_client: AtCoderClient,
    ...
    if len(content.get_samples()) == 0:
        ...
        FileCreator.create_examples(content.get_samples(), workspace_dir_path)
    ...
    try:
        ...
        FileCreator.create_code_from_prediction_result(result, CppCodeGenerator(template_success), code_file_path)
