![Build Status](https://github.com/kyuridenamida/atcoder-tools/actions/workflows/tests.yml/badge.svg?branch=stable)
...
AtCoder Tools
====
Python 3.10 から 3.14 で動作する [AtCoder](https://atcoder.jp/) からサンプル入力をダウンロードしたりする際に便利なツールです。
