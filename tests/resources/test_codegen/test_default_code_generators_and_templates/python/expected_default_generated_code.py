...
# Generated by 1.1.2 https://github.com/kyuridenamida/atcoder-tools  (tips: You use the default template now. You can remove this line with customizing your template)
def main():
    def iterate_tokens():
