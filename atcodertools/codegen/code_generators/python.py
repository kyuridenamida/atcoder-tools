...
from atcodertools.codegen.homogeneous_query_python_generator import (
    HomogeneousQueryPythonGenerator,
)
...
def _homogeneous_query_parameters(
    args,
    information_path,
):
    prefix_generator = (
    ...
    if not nested_input_part.startswith(
        ...
        raise ValueError(
            "homogeneous-query input fragment "
