...
CPP = Language(
    ...
    display_name="C++",
    extension="cpp",
    submission_lang_pattern=re.compile(".*C\\+\\+ 20 "),
...
RUST = Language(
    ...
    display_name="Rust",
    extension="rs",
    submission_lang_pattern=re.compile(".*Rust \\(rustc 1.*"),
...
PYTHON = Language(
    ...
    display_name="Python",
    extension="py",
    submission_lang_pattern=re.compile(".*Python \\(CPython 3.*"),
...
NIM = Language(
    ...
    display_name="NIM",
    extension="nim",
    submission_lang_pattern=re.compile(".*Nim \\(Nim 1.*"),
...
CSHARP = Language(
    ...
    display_name="C#",
    extension="cs",
    submission_lang_pattern=re.compile(".*C# 11.0 "),
...
GO = Language(
    ...
    display_name="Go",
    extension="go",
    submission_lang_pattern=re.compile(".*Go \\(go 1.*"),
