...
_PR325_HOMOGENEOUS_TARGET_SPECS: Dict[
    Tuple[str, str],
    TargetSpec,
] = {
    (
        'atcodertools.fmtprediction.homogeneous_query',
    ...
    (
        'atcodertools.fmtprediction.models.homogeneous_query_format',
...
def _observe_reachable_query_targets_with_specs(
    result: Any,
    observer: QueryIRShadowObserver,
    target_specs: Dict[
        Tuple[str, str],
    ...
    while stack:
        ...
        if type_key in target_specs:
            category, field_roles = (
                target_specs[type_key]
            )
            returned = observer.observe(
                instance=value,
                category=category,
...
def _require_observed_target_with_specs(
    result: Any,
    observer: Optional[
        QueryIRShadowObserver
    ],
    ...
    observed = (
        _observe_reachable_query_targets_with_specs(
            result,
            observer,
            target_specs,
        )
...
def _create_homogeneous_query_typed_format_with_shadow(
    producer: Any,
    format_: Any,
    var_to_type: Any,
    *,
    ...
    return _require_observed_target_with_specs(
        result,
        observer,
...
def _create_homogeneous_prediction_with_shadow(
    producer: Any,
    prefix_format: Any,
    query_count_var: str,
    argument_names: Any,
